...
{
    sealed public class Deflection : Angle
    {
        ...
        public Deflection(double anAngleDbl, int deflectionDirection)
        {
            ...
            //base.angle__ = Angle.normalizeToPlusOrMinus2PiStatic(anAngleDbl);
            //angle_ = anAngleDbl;
        }
        ...
        {
            return new Deflection(Angle.HALFCIRCLE / 2.0 * deflDirection);
        }
        ...
        public static implicit operator Deflection(DegreeOfCurve degrees)
        {
